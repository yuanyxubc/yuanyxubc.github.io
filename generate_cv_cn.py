...
def build_cv():
    ...
    entry("2025 \u2013 2029", [
        ...
        P(f'\u521b\u610f\u4e0e\u6279\u5224\u7814\u7a76\u5b66\u9662\u3002\u5bfc\u5e08\uff1aProf. Aleksandra Dulic \u548c Prof. Patricia Lasserre\u3002\u7814\u7a76\u65b9\u5411\uff1a\u4e0e\u539f\u4f4f\u6c11\u793e\u533a\u5171\u540c\u8bbe\u8ba1\u6559\u80b2\u6e38\u620f\u4ee5\u4fc3\u8fdb\u73af\u5883\u97e7\u6027\u3002\u83b7Okanagan\u7814\u7a76\u751f\u5956\u5b66\u91d1 (OGRS) \u53ca\u56fd\u9645\u535a\u58eb\u90e8\u5206\u5b66\u8d39\u51cf\u514d (IDPT)\u3002')
    ])
    entry("2020 \u2013 2023", [
        P(f'<font name="{B}">\u8bbe\u8ba1\u5b66\u7855\u58eb (M.Des.)</font>','entry_title'),
        P('\u540c\u6d4e\u5927\u5b66\uff0c\u4e0a\u6d77'),
        P('GPA: 89.9/100\u3002\u5168\u989d\u5956\u5b66\u91d1\u3002\u6bd5\u4e1a\u5178\u793c\u4ee3\u8868\u53d1\u8a00 (2023)\u3002')
    ])
    entry("2016 \u2013 2020", [
        P(f'<font name="{B}">\u591a\u5b66\u79d1\u4e0e\u8de8\u5b66\u79d1\u827a\u672f\u5b66\u58eb\uff08\u8363\u8a89\uff09(B.F.A. Honours)</font>','entry_title'),
        P('\u534e\u4e1c\u7406\u5de5\u5927\u5b66\uff0c\u4e0a\u6d77'),
        P('GPA: 3.7/4.0\uff0c\u4e13\u4e1a\u6392\u540d\u7b2c\u4e00\u3002\u56fd\u5bb6\u5956\u5b66\u91d1 (\u524d0.2%)\u3002\u4e0a\u6d77\u5e02\u4f18\u79c0\u6bd5\u4e1a\u751f (\u524d2%)\u3002\u6bd5\u4e1a\u5178\u793c\u4ee3\u8868\u53d1\u8a00 (2020)\u3002')
    ])
    entry("2023 \u2013 2025", [
        P(f'<font name="{B}">\u6e38\u620f\u884c\u4e1a\u4e13\u4e1a\u57f9\u8bad (48\u5468 + 16\u5468\u5bfc\u5e08\u5236)</font>','entry_title'),
    ...
    for a,t,v,d in [
        ...
        ("X. Shan, <b>Y. Xu*</b>, Y.-S. Lin","\u91cd\u65b0\u601d\u8003\u4e2d\u56fd\u6d88\u8d39\u8005\u7684\u8461\u8404\u9152\u54c1\u5c1d","HCII 2025, Springer, 2025",None),
    ...
    # ---- \u5b66\u672f\u62a5\u544a ----
    section("\u5b66\u672f\u62a5\u544a\u4e0e\u53d1\u8868")
    entry("2026\u5e746\u6708", [P(f'<font name="{B}">Y. Xu</font> \u7b49\u3002\u4e09\u7bc7\u8bba\u6587\u3002HCII 2026\uff0c\u8499\u7279\u5229\u5c14\u3002')])
    entry("2026\u5e746\u6708", [P(f'<font name="{B}">Y. Xu</font> \u7b49\u3002\u535a\u58eb\u751f\u7814\u8ba8\u4f1a\u53ca\u6559\u80b2\u4e13\u9898\u3002DiGRA 2026\uff0c\u7231\u5c14\u5170\u3002')])
    entry("2025", [P(f'<font name="{B}">Y. Xu</font>, Y.-S. Lin. \u300cSituated Bodies, Wandering Minds\u300d ACM SIGGRAPH 2025\uff0c\u6e29\u54e5\u534e \u2014 BOF \u4e13\u573a\u3002')])
    entry("2024", [P(f'<font name="{B}">Y. Xu</font>. \u300cCreativity for Sensational Perception\u300d HCI International 2024\uff0c\u534e\u76db\u987f DC\u3002')])
    ...
    section("\u5b66\u672f\u670d\u52a1")
    story.append(P(
        f'<font name="{B}">ACM CHI</font> \u2014 2\u00d7 \u4f18\u79c0\u5ba1\u7a3f (2025) &nbsp;&nbsp; <font name="{B}">ACM DIS</font> &nbsp;&nbsp; <font name="{B}">ACM C&amp;C</font> &nbsp;&nbsp; <font name="{B}">ACM UIST</font> &nbsp;&nbsp; <font name="{B}">ACM ETRA</font><br/>'
        f'<font name="{B}">ACM IMX</font> &nbsp;&nbsp; <font name="{B}">ACM CUI</font> &nbsp;&nbsp; <font name="{B}">ACM Auto UI</font> &nbsp;&nbsp; <font name="{B}">IEEE ISMAR</font> &nbsp;&nbsp; <font name="{B}">IEEE VR</font> &nbsp;&nbsp; <font name="{B}">EuroVis</font><br/>'
        f'<font name="{B}">CAADRIA</font> (\u56fd\u9645\u5ba1\u59d4\u4f1a\u59d4\u5458) &nbsp;&nbsp; <font name="{B}">IJHCI</font> &nbsp;&nbsp; <font name="{B}">ITA</font>'
    ))
    ...
    section("\u83b7\u5956\u4e0e\u8363\u8a89")
    for y, d in [
        ("2025","OGRS + IDPT \u2014 \u4e0d\u5217\u98a0\u54e5\u4f26\u6bd4\u4e9a\u5927\u5b66\uff0c4\u5e74\u535a\u58eb\u8d44\u52a9"),
        ("2025","\u4f18\u79c0\u5ba1\u7a3f \u00d72 \u2014 ACM CHI"),
        ("2025","Rookie of the Year \u2014 A Ranking (\u6e38\u620f\u7c7b) \u2014 The Rookies Awards"),
        ("2024","Rookie of the Year \u2014 A Ranking (\u89c6\u6548+3D\u52a8\u753b) \u2014 The Rookies Awards"),
        ("2023","\u6bd5\u4e1a\u5178\u793c\u4ee3\u8868\u53d1\u8a00 \u2014 \u540c\u6d4e\u5927\u5b66"),
        ("2021","\u5168\u989d\u5956\u5b66\u91d1 \u2014 \u540c\u6d4e\u5927\u5b66"),
        ...
        ("2017","\u56fd\u5bb6\u5956\u5b66\u91d1 (\u524d0.2%) \u2014 \u4e2d\u534e\u4eba\u6c11\u5171\u548c\u56fd\u6559\u80b2\u90e8"),
        ("2016\u20132019","\u6210\u601d\u5371\u540d\u8a89\u6821\u957f\u5956\u5b66\u91d1 (\u524d1%) + \u7279\u7b49\u5b66\u4e1a\u5956\u5b66\u91d1 \u2014 \u4e13\u4e1a\u7b2c\u4e00\uff0c\u8fde\u7eed5\u5b66\u671f \u2014 \u534e\u4e1c\u7406\u5de5\u5927\u5b66"),
    ]: entry(y, [P(d)], sp=2)
